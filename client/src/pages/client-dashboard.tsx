                ...
                <div key={r.def.name} className="rounded-xl overflow-hidden flex shadow-sm border border-border">
                  ...
                  <div className="w-80 flex-shrink-0 flex flex-col border-r border-border">
                    ...
                    <div className="bg-card px-4 pt-3 pb-3 flex-1 flex flex-col">
                      {/* Column headers */}
                      <div className="grid mb-2 gap-1" style={{ gridTemplateColumns: "1fr 68px 44px 44px" }}>
                        ...
                        <span className="text-[9px] uppercase tracking-widest font-bold text-muted-foreground text-right">Gross</span>
                        <span className="text-[9px] uppercase tracking-widest font-bold text-muted-foreground text-right">AT Yld</span>
                      </div>
                      <div className="space-y-1.5 flex-1">
                        {r.subAccounts.map(acct => (
                          <div key={acct.name} className="grid items-center gap-1" style={{ gridTemplateColumns: "1fr 68px 44px 44px" }}>
                      ...
                      <div className="mt-2.5 pt-2 border-t border-border">
                        <div className="grid items-center gap-1" style={{ gridTemplateColumns: "1fr 68px 44px 44px" }}>
